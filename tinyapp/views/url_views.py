...
class URLListView (LoginRequiredMixin,ListView):  
    ...
    # Get cookie info from context data
...
class UrlDeleteView(DeleteView):
    ...
    model=Url
    success_url=reverse_lazy("urls") #Redirect to the urls list
...
class UrlUpdateView(UpdateView):
    ...
    model = Url
    form_class = UrlModelForm
    template_name = 'urls_detail.html' # template for updating URL
    success_url=reverse_lazy("urls")  # Redirect to the urls list on success
